  ...
  <main class="home">
    ...
    <section class="hero" :class="{ 'fade-in': visible }">
      <div class="hero-container">
        ...
        <div class="hero-content">
          ...
          <RouterLink to="/noticias" class="hero-button">EXPLORAR AHORA</RouterLink>
        </div>
    ...
    <section class="content-cards">
      <div class="cards-container">
        ...
        <!-- Merchandising Card -->
        <router-link to="/create-skin" class="card-link content-card  full-width" aria-label="Ir a crear avatar">
          <div class="card-inner">
