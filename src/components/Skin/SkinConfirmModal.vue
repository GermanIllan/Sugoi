      ...
      <div class="confirm-modal border-thick shadow-lg" @click.stop>
        <div class="confirm-body">
          ...
          <div class="confirm-actions">
            <button class="button-primary cancel-btn border-thick shadow-xs" @click="$emit('cancel')">
              <span class="kanji-btn">キャンセル</span>
              CANCELAR
            </button>
            <button class="button-primary delete-btn border-thick shadow-xs" @click="$emit('confirm')">
